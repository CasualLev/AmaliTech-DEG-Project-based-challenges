...
Late deliveries are a **regional problem, not a nationwide one, and they are overwhelmingly the carrier's fault, not the sellers'.** Across ~96.5k delivered orders, 8.1% missed the promised delivery date, but the failures concentrate in the Northeast (Alagoas 23.9%, Maranhão 19.7% vs. São Paulo ~6%), while Rio de Janeiro contributes the largest single pile of late orders through sheer volume. The cost is measurable: on-time orders average **4.29 stars**, while orders more than 5 days late collapse to **1.78** and worryingly, these "Super Late" failures (4.2% of orders) outnumber mildly late ones, meaning when we miss, we miss badly. Decomposing each late delivery into its seller leg and carrier leg shows **72.8% of late orders were dispatched on time by the seller and lost in transit**, with the carrier leg increasing from 7.4 days (on-time orders) to 32.6 days (super-late). Recommended focus: renegotiate carrier lanes serving the Northeast, recalibrate delivery estimates in that region, and add seller dispatch enforcement specifically in Rio de Janeiro.
